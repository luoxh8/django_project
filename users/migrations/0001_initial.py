    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nick',
                 models.CharField(blank=True, default='', help_text='昵称', max_length=30, null=True, verbose_name='昵称')),
                ...
                ('platform',
                 models.CharField(choices=[('ios', '苹果用户'), ('android', '安卓设备'), ('core', '未知设备')], default='core',
                                  max_length=20, verbose_name='登录设备类型')),
                ('device_id', models.CharField(blank=True, default='', max_length=40, null=True, verbose_name='设备id')),
                ('register_ip',
                 models.CharField(blank=True, default='', max_length=20, null=True, verbose_name='注册时候的IP')),
                ('phone', models.CharField(blank=True, default='', max_length=11, null=True, verbose_name='手机号码')),
                ('level',
                 models.CharField(choices=[(0, '普通用户'), (1, '一级用户')], default=0, max_length=2, verbose_name='用户等级')),
                ...
                ('oauth_from',
                 models.CharField(choices=[('weixin', '微信'), ('weibo', '微博'), ('qq', 'QQ'), ('phone', '手机')],
                                  default='', max_length=10, verbose_name='验证来源')),
